...
class _SelectNearestActiveDriversScreenState extends State<SelectNearestActiveDriversScreen>
{
  ...
  getFareAmountAccordingToVehicleType(int index)
  {
    if(tripDirectionDetailsInfo != null)
    {
      ...
      if(dList[index]["car_details"]["type"].toString() == "auto") //means executive type of car - more comfortable pro level
      {
        fareAmount = (AssistantMethods.calculateFareAmountFromOriginToDestination(tripDirectionDetailsInfo!) * 2.5).toStringAsFixed(1);
      }
      if(dList[index]["car_details"]["type"].toString() == "car") // non - executive car - comfortable
      {
        fareAmount = (AssistantMethods.calculateFareAmountFromOriginToDestination(tripDirectionDetailsInfo!)* 4).toString();
      }
    }
    return fareAmount;
  }
