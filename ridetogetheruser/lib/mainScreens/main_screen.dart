...
import 'package:ridetogetheruser/assistants/geofire_assistant.dart';
import 'package:ridetogetheruser/global/global.dart';
import 'package:ridetogetheruser/infoHandler/app_info.dart';
import 'package:ridetogetheruser/mainScreens/rate_driver_screen.dart';
import 'package:ridetogetheruser/mainScreens/search_places_screen.dart';
import 'package:ridetogetheruser/mainScreens/select_nearest_active_driver_screen.dart';
import 'package:ridetogetheruser/models/active_nearby_available_drivers.dart';
import 'package:ridetogetheruser/widgets/my_drawer.dart';
import 'package:ridetogetheruser/widgets/pay_fare_amount_dialog.dart';
                  ...
                  child: Column(
                    children: [
                      ...
                      onTap: () async
                      {
                        ...
                        if(responseFromSearchScreen == "userPickUpLocation")
                        {
                          setState(() {
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                ...
                                onPressed: ()
                                {
                                  ...
                                  // Navigator.push(context, MaterialPageRoute(builder: (c)=>  MainScreens()));
                                  if(Provider.of<AppInfo>(context, listen: false).userDropOffLocation != null)
                                  {
                                    saveRideRequestInformation();
                                  }
